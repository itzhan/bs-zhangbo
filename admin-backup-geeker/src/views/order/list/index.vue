    ...
    <el-dialog v-model="detailVisible" title="订单详情" width="700px">
      <el-descriptions :column="2" border v-if="detailData.order">
        ...
        <el-descriptions-item label="状态"
          ><el-tag :type="statusTagType(detailData.order.status)">{{
            statusMap[detailData.order.status]
        ...
        <el-descriptions-item label="取件时段"
          >{{ detailData.order.pickupDate }} {{ detailData.order.pickupTime }}</el-descriptions-item
        >
